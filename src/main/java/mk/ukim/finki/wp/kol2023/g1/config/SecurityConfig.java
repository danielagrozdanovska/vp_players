        ...
        http
                ...
                .authorizeHttpRequests( (requests) -> requests
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/"),
                                AntPathRequestMatcher.antMatcher("/players")).permitAll()
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/players/**/vote")).hasRole("USER")
                        .requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.valueOf("/players/**"), "/players")).hasAnyRole("ADMIN")
                        .anyRequest()
                        .authenticated()
                )
                .formLogin((form) -> form
